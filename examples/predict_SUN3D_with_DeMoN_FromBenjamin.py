...
outdir = "/home/kevin/anaconda_tensorflow_demon_ws/demon/datasets/traindata/sun3d_train_0.1m_to_0.2m/demon_prediction"
outfile = "/home/kevin/anaconda_tensorflow_demon_ws/demon/datasets/traindata/sun3d_train_0.1m_to_0.2m/demon_prediction/demon_sun3d_train_0.1m_to_0.2m.h5"
    ...
    for h5key in data.keys():
        if h5key.split('-')[0] == 'hotel_beijing.beijing_hotel_2':
            ...
            if not new_v is None:
                ...
                id_image_list.append((h5key+'_v0'))
                views.append(new_v)
                # Kevin: visualization
            ...
            if not new_v is None:
                # id_image_list.append((cnt,image))
                id_image_list.append((h5key+'_v1'))
                views.append(new_v)
                # Kevin: visualization
                # visualize_views(tmp_views)
                cnt += 1
