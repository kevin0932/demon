...
if True:
    ...
    np.savetxt(os.path.join(outdir,'gistScore_allNeighbours_record.txt'), gistScore_allNeighbours_record)
    np.savetxt(os.path.join(outdir,'gistScore_goodNeighbours_record.txt'), gistScore_goodNeighbours_record)
