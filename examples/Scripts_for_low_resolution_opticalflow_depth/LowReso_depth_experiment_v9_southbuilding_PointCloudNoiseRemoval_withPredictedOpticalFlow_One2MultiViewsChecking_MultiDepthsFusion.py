...
# outdir = "/home/kevin/anaconda_tensorflow_demon_ws/demon/datasets/traindata/SUN3D_Train_hotel_beijing~beijing_hotel_2/demon_prediction"
# # infile = "/home/kevin/anaconda_tensorflow_demon_ws/demon/datasets/traindata/SUN3D_Train_hotel_beijing~beijing_hotel_2/demon_prediction/kevin_exhaustive_demon.h5"
# infile = "/home/kevin/anaconda_tensorflow_demon_ws/demon/datasets/traindata/SUN3D_Train_hotel_beijing~beijing_hotel_2/demon_prediction/demon_sun3d_train_hotel_beijing~beijing_hotel_2.h5"
# ExhaustivePairInfile = "/home/kevin/anaconda_tensorflow_demon_ws/demon/datasets/traindata/SUN3D_Train_hotel_beijing~beijing_hotel_2/demon_prediction/demon_sun3d_train_hotel_beijing~beijing_hotel_2.h5"
# recondir = '/home/kevin/anaconda_tensorflow_demon_ws/demon/datasets/traindata/SUN3D_Train_hotel_beijing~beijing_hotel_2/demon_prediction/images_demon/dense'

outdir = "/media/kevin/SamsungT5_F/ThesisDATA/southbuilding/filteringtest_6448"
infile = "/media/kevin/SamsungT5_F/ThesisDATA/southbuilding/demon_prediction/more_pairs_southbuilding_predictions_05022018.h5"
ExhaustivePairInfile = "/media/kevin/SamsungT5_F/ThesisDATA/southbuilding/demon_prediction/more_pairs_southbuilding_predictions_05022018.h5"
...
def findOne2MultiPairs(infile, ExhaustivePairInfile, data_format, target_K, w, h, cameras, images, TheiaGlobalPosesGT, TheiaRelativePosesGT, image1_filename='hotel_beijing~beijing_hotel_2-0000181_baseline_1_v0.JPG'):
    ...
    return One2MultiImagePairs_192by256RGB, image_pairs_One2Multi, One2MultiImagePairs_DeMoN, One2MultiImagePairs_GT, One2MultiImagePairs_Colmap, One2MultiImagePairs_correctionGT, One2MultiImagePairs_correctionColmap
...
for referenceImage1 in image1_filename_set:
    ...
    if len(image_pairs_One2Multi) >= One2MultiViewLimit:
        One2MultiImagePairs_192by256RGB_dict[referenceImage1] = One2MultiImagePairs_192by256RGB
...
def main():
    ...
    print("retrived reference image1 = ", filteredScaledDepth_dict.keys())
    ...
    for ref_img1 in filteredScaledDepth_dict.keys():
        ...
        for ref_img2 in sorted_pair_pos_dist.keys():
            ...
            predictedLSDepth = result['predict_depth2'].squeeze()
        ...
        ## filter by distance
        scaled_depth1_1D = np.reshape(scaled_depth1, [scaled_depth1.shape[0]*scaled_depth1.shape[1]])
        scaled_depth1_1DMask = scaled_depth1_1D<2.2
        scaled_depth1_1DMask = scaled_depth1_1DMask.astype(np.bool)
        print("maskfusion.shape = ", maskfusion.shape, "; scaled_depth1_1DMask.shape = ", scaled_depth1_1DMask.shape )
        maskfusion = maskfusion & scaled_depth1_1DMask
        print("maskfusion.shape = ", maskfusion.shape)
        cam1_polydata = create_camera_polydata(R1, t1, True)
        pointcloud1_polydata = create_pointcloud_polydata(
    ...
    plywriter = vtk.vtkPLYWriter()
    plywriter.SetFileName(os.path.join(outdir,'one2multiviewchecking_multidepthfusion_filtered_pointcloud.ply'))
