...
def main():
    ...
    forwardlooking_images_list = ['DSC_1174.JPG', 'DSC_1175.JPG', 'DSC_1176.JPG', 'DSC_1177.JPG', 'DSC_1178.JPG', 'DSC_1179.JPG',
                                    'DSC_1180.JPG', 'DSC_1181.JPG', 'DSC_1182.JPG', 'DSC_1183.JPG', 'DSC_1184.JPG', 'DSC_1185.JPG', 'DSC_1186.JPG', 'DSC_1187.JPG', 'DSC_1188.JPG', 'DSC_1189.JPG',
                                    'DSC_1190.JPG', 'DSC_1191.JPG', 'DSC_1192.JPG', 'DSC_1193.JPG', 'DSC_1194.JPG', 'DSC_1195.JPG', 'DSC_1196.JPG', 'DSC_1197.JPG', 'DSC_1198.JPG', 'DSC_1199.JPG']

    backwardlooking_images_list = ['DSC_1221.JPG', 'DSC_1222.JPG', 'DSC_1223.JPG', 'DSC_1224.JPG', 'DSC_1225.JPG', 'DSC_1226.JPG',
                                    'DSC_1230.JPG', 'DSC_1231.JPG', 'DSC_1232.JPG', 'DSC_1233.JPG', 'DSC_1234.JPG', 'DSC_1235.JPG', 'DSC_1236.JPG', 'DSC_1237.JPG', 'DSC_1238.JPG', 'DSC_1239.JPG',
                                    'DSC_1240.JPG', 'DSC_1241.JPG', 'DSC_1242.JPG', 'DSC_1243.JPG', 'DSC_1244.JPG', 'DSC_1245.JPG', 'DSC_1246.JPG', 'DSC_1247.JPG', 'DSC_1248.JPG', 'DSC_1249.JPG',
                                    'DSC_1250.JPG', 'DSC_1251.JPG', 'DSC_1252.JPG', 'DSC_1253.JPG', 'DSC_1254.JPG', 'DSC_1255.JPG']


    for image_pair12 in data.keys():
    # suspicious_pairs_list = ['DSC_1183.JPG---DSC_1237.JPG']
    # for image_pair12 in suspicious_pairs_list:
        image_name1, image_name2 = image_pair12.split('---')

        FB_Flag = False
        if (image_name1 in forwardlooking_images_list and image_name2 in backwardlooking_images_list) or (image_name2 in forwardlooking_images_list and image_name1 in backwardlooking_images_list):
            FB_Flag = True
        if FB_Flag==False:
            continue
        ...
        if survivor_ratio >= args.survivor_ratio and survivor_ratio_21 >= args.survivor_ratio:
            valid_pair_num += 1
        ...
        #     print("bi-dir survivor-ratio = ", survivor_ratio, " ", survivor_ratio_21)
            ...
            print("rotation12 = ", rotation12, "; rotation21 = ", rotation21)
            ColmapR21 = np.dot(ColmapImages[image_name1].R, ColmapImages[image_name2].R.T)
            print("ColmapR12 = ", ColmapR12, "; ColmapR21 = ", ColmapR21)

            DeMoN_CamPos2in1 = - np.dot(rotation12.T, translation12)
            DeMoN_CamPos1in2 = - np.dot(rotation21.T, translation21)
            Colmap_CamPos2in1 = np.dot(ColmapImages[image_name1].R, (ColmapCamPos2-ColmapCamPos1))
            Colmap_CamPos1in2 = np.dot(ColmapImages[image_name2].R, (ColmapCamPos1-ColmapCamPos2))
            print("DeMoN_CamPos2in1 = ", DeMoN_CamPos2in1, "; DeMoN_CamPos1in2 = ", DeMoN_CamPos1in2)
            print("Colmap_CamPos2in1 = ", Colmap_CamPos2in1, "; Colmap_CamPos1in2 = ", Colmap_CamPos1in2)

            print("rotation_error_from_ColmapR*180/math.pi = ", rotation_error_from_ColmapR*180/math.pi)
            print("rotation_error_from_identity*180/math.pi = ", rotation_error_from_identity*180/math.pi)
            print("TransAngularErrFromColmap*180/math.pi = ", TransAngularErrFromColmap*180/math.pi)
            print("TransAngularErr*180/math.pi = ", TransAngularErr*180/math.pi)
            print("view_angle_imagepair*180/math.pi = ", view_angle_imagepair*180/math.pi, "; baselineLength = ", baselineLength)
