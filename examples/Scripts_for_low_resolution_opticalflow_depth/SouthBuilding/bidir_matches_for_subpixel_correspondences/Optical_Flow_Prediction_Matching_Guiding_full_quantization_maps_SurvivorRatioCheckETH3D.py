...
def main():
    ...
    for max_sq_pixel_err in max_sq_pixel_errs:
        ...
        plt.figure()
        plt.scatter(survivor_ratio_threshold_list, np.array(survivor_mask_25_25_pair_num_from_inliers_5_5), s=4, c='b', marker="X", label='inliers: R_error<=5, t_error<=5')#, c=colors, alpha=0.5)
        plt.scatter(survivor_ratio_threshold_list, np.array(survivor_mask_25_25_pair_num_from_inliers_15_15), s=4, c='g', marker="*", label='inliers: R_error<=15, t_error<=15')#, c=colors, alpha=0.5)
        plt.scatter(survivor_ratio_threshold_list, np.array(survivor_mask_25_25_pair_num_from_inliers_25_25), s=4, c='r', marker="o", label='inliers: R_error<=25, t_error<=25')#, c=colors, alpha=0.5)
        plt.scatter(survivor_ratio_threshold_list, np.array(survivor_mask_25_25_pair_num_from_inliers_35_35), s=4, c='c', marker="D", label='inliers: R_error<=35, t_error<=35')#, c=colors, alpha=0.5)
        plt.scatter(survivor_ratio_threshold_list, np.array(survivor_mask_25_25_pair_num_from_inliers_50_50), s=4, c='m', marker="X", label='inliers: R_error<=50, t_error<=50')#, c=colors, alpha=0.5)
        plt.scatter(survivor_ratio_threshold_list, np.array(survivor_mask_25_25_pair_num_from_inliers_75_75), s=4, c='y', marker="*", label='inliers: R_error<=75, t_error<=75')#, c=colors, alpha=0.5)
        plt.scatter(survivor_ratio_threshold_list, np.array(survivor_mask_25_25_pair_num_from_inliers_100_100), s=4, c='k', marker="o", label='inliers: R_error<=100, t_error<=100')#, c=colors, alpha=0.5)
        plt.scatter(survivor_ratio_threshold_list, np.array(survivor_mask_25_25_pair_num_from_inliers_150_150), s=4, c='#0F5684', marker="D", label='inliers: R_error<=150, t_error<=150')#, c=colors, alpha=0.5)
        plt.ylabel('survivor_pair_percentage_of_all_good_pairs');
        plt.xlabel('survivor_ratio_threshold_list');
        plt.legend(loc='upper right');
        plt.title("varying accuracy: survivor_pair_percentage_of_all_good_pairs vs survivor_ratio_threshold_list")
        plt.savefig(os.path.join(args.output_path,"varing_accuracy_max_sq_pixel_err_%s_goodpair_survivor_percentage_vs_survivor_ratio_threshold_list.png"%(max_sq_pixel_err)))
        # plt.show()

        plt.figure()
        plt.scatter(survivor_ratio_threshold_list, np.array(survivor_mask_360_360_pair_num_from_inliers_5_5), s=4, c='b', marker="X", label='inliers: R_error<=5, t_error<=5')#, c=colors, alpha=0.5)
        plt.scatter(survivor_ratio_threshold_list, np.array(survivor_mask_360_360_pair_num_from_inliers_15_15), s=4, c='g', marker="*", label='inliers: R_error<=15, t_error<=15')#, c=colors, alpha=0.5)
        plt.scatter(survivor_ratio_threshold_list, np.array(survivor_mask_360_360_pair_num_from_inliers_25_25), s=4, c='r', marker="o", label='inliers: R_error<=25, t_error<=25')#, c=colors, alpha=0.5)
        plt.scatter(survivor_ratio_threshold_list, np.array(survivor_mask_360_360_pair_num_from_inliers_35_35), s=4, c='c', marker="D", label='inliers: R_error<=35, t_error<=35')#, c=colors, alpha=0.5)
        plt.scatter(survivor_ratio_threshold_list, np.array(survivor_mask_360_360_pair_num_from_inliers_50_50), s=4, c='m', marker="X", label='inliers: R_error<=50, t_error<=50')#, c=colors, alpha=0.5)
        plt.scatter(survivor_ratio_threshold_list, np.array(survivor_mask_360_360_pair_num_from_inliers_75_75), s=4, c='y', marker="*", label='inliers: R_error<=75, t_error<=75')#, c=colors, alpha=0.5)
        plt.scatter(survivor_ratio_threshold_list, np.array(survivor_mask_360_360_pair_num_from_inliers_100_100), s=4, c='k', marker="o", label='inliers: R_error<=100, t_error<=100')#, c=colors, alpha=0.5)
        plt.scatter(survivor_ratio_threshold_list, np.array(survivor_mask_360_360_pair_num_from_inliers_150_150), s=4, c='#0F5684', marker="D", label='inliers: R_error<=150, t_error<=150')#, c=colors, alpha=0.5)
        plt.ylabel('survivor_pair_percentage_of_all_good_pairs');
        plt.xlabel('survivor_ratio_threshold_list');
        plt.legend(loc='upper right');
        plt.title("varying accuracy: survivor_pair_percentage_of_all_good_pairs vs survivor_ratio_threshold_list")
        plt.savefig(os.path.join(args.output_path,"varing_accuracy_360_360_max_sq_pixel_err_%s_goodpair_survivor_percentage_vs_survivor_ratio_threshold_list.png"%(max_sq_pixel_err)))
        # plt.show()

        plt.figure()
        plt.scatter(survivor_ratio_threshold_list, np.array(survivor_mask_5_5_pair_num_from_inliers_25_25), s=4, c='b', marker="X", label='inliers: R_consistency_error<=5, t_consistency_error<=5')#, c=colors, alpha=0.5)
        plt.scatter(survivor_ratio_threshold_list, np.array(survivor_mask_15_15_pair_num_from_inliers_25_25), s=4, c='g', marker="*", label='inliers: R_consistency_error<=15, t_consistency_error<=15')#, c=colors, alpha=0.5)
        plt.scatter(survivor_ratio_threshold_list, np.array(survivor_mask_25_25_pair_num_from_inliers_25_25), s=4, c='r', marker="o", label='inliers: R_consistency_error<=25, t_consistency_error<=25')#, c=colors, alpha=0.5)
        plt.scatter(survivor_ratio_threshold_list, np.array(survivor_mask_35_35_pair_num_from_inliers_25_25), s=4, c='c', marker="D", label='inliers: R_consistency_error<=35, t_consistency_error<=35')#, c=colors, alpha=0.5)
        plt.scatter(survivor_ratio_threshold_list, np.array(survivor_mask_50_50_pair_num_from_inliers_25_25), s=4, c='m', marker="X", label='inliers: R_consistency_error<=50, t_consistency_error<=50')#, c=colors, alpha=0.5)
        plt.scatter(survivor_ratio_threshold_list, np.array(survivor_mask_75_75_pair_num_from_inliers_25_25), s=4, c='y', marker="*", label='inliers: R_consistency_error<=75, t_consistency_error<=75')#, c=colors, alpha=0.5)
        plt.scatter(survivor_ratio_threshold_list, np.array(survivor_mask_100_100_pair_num_from_inliers_25_25), s=4, c='k', marker="o", label='inliers: R_consistency_error<=100, t_consistency_error<=100')#, c=colors, alpha=0.5)
        plt.scatter(survivor_ratio_threshold_list, np.array(survivor_mask_150_150_pair_num_from_inliers_25_25), s=4, c='#0F5684', marker="D", label='inliers: R_consistency_error<=150, t_consistency_error<=150')#, c=colors, alpha=0.5)
        plt.ylabel('survivor_pair_percentage_of_all_good_pairs');
        plt.xlabel('survivor_ratio_threshold_list');
        plt.legend(loc='upper right');
        plt.title("varying consistency: survivor_pair_percentage_of_all_good_pairs vs survivor_ratio_threshold_list")
        plt.savefig(os.path.join(args.output_path,"varing_consistency_max_sq_pixel_err_%s_goodpair_survivor_percentage_vs_survivor_ratio_threshold_list.png"%(max_sq_pixel_err)))
        # plt.show()
        ...
        plt.figure()
        plt.scatter(survivor_ratio_threshold_list, survivor_pair_num_list_npArr, s=4)#, c=colors, alpha=0.5)
        plt.ylabel('survivor_pair_num_list');
        plt.xlabel('survivor_ratio_threshold_list');
        plt.title("survivor_pair_ratio_list vs survivor_ratio_threshold_list")
        plt.savefig(os.path.join(args.output_path,"max_sq_pixel_err_%s_survivor_pair_ratio_list_vs_survivor_ratio_threshold_list.png"%(max_sq_pixel_err)))
        # plt.show()
        ...
        plt.figure()
        plt.scatter(survivor_ratio_threshold_list, update1_survivor_pair_num_list_npArr, s=4, c='b', marker="s", label='inliers_from_rotation')#, c=colors, alpha=0.5)
        plt.scatter(survivor_ratio_threshold_list, survivor_pair_num_list_npArr, s=4, c='r', marker="o", label='inliers_from_leftright')#, c=colors, alpha=0.5)
        # ax1.scatter(x[:4], y[:4], s=10, c='b', marker="s", label='first')
        # ax1.scatter(x[40:],y[40:], s=10, c='r', marker="o", label='second')
        plt.ylabel('survivor_pair_percentage_of_all_pairs');
        plt.xlabel('survivor_ratio_threshold_list');
        plt.legend(loc='upper right');
        plt.title("survivor_pair_percentage_of_all_pairs vs survivor_ratio_threshold_list")
        plt.savefig(os.path.join(args.output_path,"max_sq_pixel_err_%s_survivor_pair_percentage_of_all_pairs_vs_survivor_ratio_threshold_list.png"%(max_sq_pixel_err)))
        # plt.show()
        ...
        plt.figure()
        plt.scatter(survivor_ratio_threshold_list, update2_survivor_pair_num_list_npArr, s=4, c='b', marker="s", label='inliers_from_rotation_and_leftright')#, c=colors, alpha=0.5)
        plt.scatter(survivor_ratio_threshold_list, update1_survivor_pair_num_list_npArr, s=4, c='g', marker="*", label='inliers_from_rotation')#, c=colors, alpha=0.5)
        plt.scatter(survivor_ratio_threshold_list, survivor_pair_num_list_npArr, s=4, c='r', marker="o", label='inliers_from_leftright')#, c=colors, alpha=0.5)
        # ax1.scatter(x[:4], y[:4], s=10, c='b', marker="s", label='first')
        # ax1.scatter(x[40:],y[40:], s=10, c='r', marker="o", label='second')
        plt.ylabel('survivor_pair_percentage_of_all_pairs');
        ...
        plt.legend(loc='upper right');
        plt.title("survivor_pair_percentage_of_all_pairs vs survivor_ratio_threshold_list")
        plt.savefig(os.path.join(args.output_path,"max_sq_pixel_err_%s_bothInliers_survivor_pair_percentage_of_all_pairs_vs_survivor_ratio_threshold_list.png"%(max_sq_pixel_err)))
        # plt.show()
        ...
        plt.figure()
        plt.scatter(survivor_ratio_threshold_list, update4_survivor_pair_num_list_npArr, s=4, c='b', marker="s", label='inliers_from_pose_and_leftright')#, c=colors, alpha=0.5)
        plt.scatter(survivor_ratio_threshold_list, update5_survivor_pair_num_list_npArr, s=4, c='g', marker="*", label='inliers_from_pose')#, c=colors, alpha=0.5)
        plt.scatter(survivor_ratio_threshold_list, update3_survivor_pair_num_list_npArr, s=4, c='r', marker="o", label='inliers_from_leftright')#, c=colors, alpha=0.5)
        plt.ylabel('survivor_pair_percentage_of_all_pairs');
        plt.xlabel('survivor_ratio_threshold_list');
        plt.legend(loc='upper right');
        plt.title("survivor_pair_percentage_of_all_pairs vs survivor_ratio_threshold_list")
        plt.savefig(os.path.join(args.output_path,"max_sq_pixel_err_%s_bothOFandPoseInliers_survivor_pair_percentage_of_all_pairs_vs_survivor_ratio_threshold_list.png"%(max_sq_pixel_err)))
        # plt.show()
