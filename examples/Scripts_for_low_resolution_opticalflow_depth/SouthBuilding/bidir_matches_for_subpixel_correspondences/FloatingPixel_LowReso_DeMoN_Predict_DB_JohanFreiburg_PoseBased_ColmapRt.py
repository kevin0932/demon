...
def flow_to_matches_float32Pixels_withDepthFiltering(flow, real_depth_map, distThreshold=8):
...
def main():
    ...
    #theia_relativeposes_from_globalposes_GTfilepath = '/media/kevin/SamsungT5_F/ThesisDATA/gerrard_hall/DBs/intermediate_results/RelativePoses_after_step7_global_position_estimation.txt'
    #theia_id_name_filepath = '/media/kevin/SamsungT5_F/ThesisDATA/gerrard_hall/DBs/intermediate_results/viewid_imagename_pairs_file.txt'
    ...
    for image_pair12 in data.keys():
        ...
        # image_pair12_transVec = t12_from_theia_motion_averaging
        # image_pair21_transVec = t12_from_theia_motion_averaging
        ...
        # scaled_depth_map1 = 1/data[image_pair12]["depth"]
        # scaled_depth_map2 = 1/data[image_pair21]["depth"]
