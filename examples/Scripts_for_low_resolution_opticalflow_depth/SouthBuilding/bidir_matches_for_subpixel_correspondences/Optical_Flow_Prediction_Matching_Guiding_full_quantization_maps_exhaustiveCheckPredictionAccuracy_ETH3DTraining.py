...
def main():
    ...
    #
    # plt.figure()
    # plt.scatter(np.array(twoview_medianDepthOverBaseline), np.array(rotation_pose_accuracy_list), s=1)
    ...
    #
    # plt.figure()
    # plt.scatter(np.array(twoview_meanDepthOverBaseline), np.array(rotation_pose_accuracy_list), s=1)
    # plt.ylabel('rotation_prediction_error_from_GT');
    ...
    #
    # plt.figure()
    # plt.scatter(np.array(twoview_medianDepthOverBaseline), np.array(translation_pose_camvec_accuracy_list), s=1)
    ...
    #
    # plt.figure()
    # plt.scatter(np.array(twoview_meanDepthOverBaseline), np.array(translation_pose_camvec_accuracy_list), s=1)
    # plt.ylabel('translation_prediction_error_from_GT');
    # plt.xlabel('twoview_meanDepthOverBaseline');
    ...
    plt.figure()
    plt.scatter(np.array(twoview_baseline_length_list), np.array(rotation_pose_accuracy_list), s=1.5)
    plt.ylabel('rotation prediction error (Degrees)', fontsize=14);
    plt.xlabel('two-view baseline length', fontsize=14);
    # plt.title("rotation_prediction_error_from_GT vs twoview_baseline_length")
    plt.savefig(os.path.join(args.output_path,"theis_rotation_prediction_error_from_GT_vs_twoview_baseline_length.png"))
    #plt.show()

    plt.figure()
    plt.scatter(np.array(twoview_view_angle_list), np.array(rotation_pose_accuracy_list), s=1.5)
    plt.ylabel('rotation prediction error (Degrees)', fontsize=14);
    plt.xlabel('two-view view angle difference (Degrees)', fontsize=14);
    # plt.title("rotation_prediction_error_from_GT vs twoview_view_angle")
    plt.savefig(os.path.join(args.output_path,"theis_rotation_prediction_error_from_GT_vs_twoview_view_angle.png"))
    #plt.show()

    plt.figure()
    plt.scatter(np.array(twoview_baseline_length_list), np.array(translation_pose_camvec_accuracy_list), s=1.5)
    plt.ylabel('translation prediction error (Degrees)', fontsize=14);
    plt.xlabel('two-view baseline length', fontsize=14);
    # plt.title("translation_prediction_error_from_GT vs twoview_baseline_length")
    plt.savefig(os.path.join(args.output_path,"theis_translation_prediction_error_from_GT_vs_twoview_baseline_length.png"))
    #plt.show()

    plt.figure()
    plt.scatter(np.array(twoview_view_angle_list), np.array(translation_pose_camvec_accuracy_list), s=1.5)
    plt.ylabel('translation prediction error (Degrees)', fontsize=14);
    plt.xlabel('two-view view angle difference (Degrees)', fontsize=14);
    # plt.title("translation_prediction_error_from_GT vs twoview_view_angle")
    plt.savefig(os.path.join(args.output_path,"theis_translation_prediction_error_from_GT_vs_twoview_view_angle.png"))
    #plt.show()

    plt.figure()
    plt.scatter(np.array(twoview_medianDepthOverBaseline), np.array(rotation_pose_accuracy_list), s=1.5)
    plt.ylabel('rotation prediction error (Degrees)', fontsize=14);
    plt.xlabel('median Depth / Baseline', fontsize=14);
    # plt.title("rotation_prediction_error_from_GT vs twoview_medianDepthOverBaseline")
    plt.savefig(os.path.join(args.output_path,"theis_rotation_prediction_error_from_GT_vs_twoview_medianDepthOverBaseline.png"))
    #plt.show()

    plt.figure()
    plt.scatter(np.array(twoview_meanDepthOverBaseline), np.array(rotation_pose_accuracy_list), s=1.5)
    plt.ylabel('rotation prediction error (Degrees)', fontsize=14);
    plt.xlabel('mean Depth / Baseline', fontsize=14);
    # plt.title("rotation_prediction_error_from_GT vs twoview_meanDepthOverBaseline")
    plt.savefig(os.path.join(args.output_path,"theis_rotation_prediction_error_from_GT_vs_twoview_meanDepthOverBaseline.png"))
    #plt.show()

    plt.figure()
    plt.scatter(np.array(twoview_medianDepthOverBaseline), np.array(translation_pose_camvec_accuracy_list), s=1.5)
    plt.ylabel('translation prediction error (Degrees)', fontsize=14);
    plt.xlabel('median Depth / Baseline', fontsize=14);
    # plt.title("translation_prediction_error_from_GT vs twoview_medianDepthOverBaseline")
    plt.savefig(os.path.join(args.output_path,"theis_translation_prediction_error_from_GT_vs_twoview_medianDepthOverBaseline.png"))
    #plt.show()

    plt.figure()
    plt.scatter(np.array(twoview_meanDepthOverBaseline), np.array(translation_pose_camvec_accuracy_list), s=1.5)
    plt.ylabel('translation prediction error (Degrees)', fontsize=14);
    plt.xlabel('mean Depth / Baseline', fontsize=14);
    # plt.title("translation_prediction_error_from_GT vs twoview_meanDepthOverBaseline")
    plt.savefig(os.path.join(args.output_path,"theis_translation_prediction_error_from_GT_vs_twoview_meanDepthOverBaseline.png"))
    #plt.show()
