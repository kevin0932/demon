...
def main():
    ...
    for image_pair12 in data.keys():
        ...
        correctionScaleColmap12 = computeCorrectionScale(data[image_pair12]['depth_upsampled'].value, view1Colmap.depth, 60)
        correctionScaleColmap21 = computeCorrectionScale(data[image_pair21]['depth_upsampled'].value, view1Colmap.depth, 60)
        ...
        scaled_depth_map1 = correctionScaleColmap12/data[image_pair12]["depth_upsampled"]
        scaled_depth_map2 = correctionScaleColmap12/data[image_pair21]["depth_upsampled"]
        # # flow12 = flow_from_depth(data[image_pair12]["depth_upsampled"]/image_pair12_transScale,
        # flow12 = flow_from_depth(data[image_pair12]["depth_upsampled"]/correctionScaleColmap12,
        ...
        # flow21 = flow_from_depth(data[image_pair21]["depth_upsampled"]/correctionScaleColmap21,
