...
outdir = "/home/kevin/anaconda_tensorflow_demon_ws/demon/datasets/traindata/SUN3D_Test_scenes11_test/demon_prediction"
outfile = "/home/kevin/anaconda_tensorflow_demon_ws/demon/datasets/traindata/SUN3D_Test_scenes11_test/demon_prediction/demon_sun3d_train_mit_w85_playroom_westgate_playroom_1_full_baselines.h5"
...
###### SUN3D Testing Dataset
inputSUN3D_trainFilePaths.append('/home/kevin/anaconda_tensorflow_demon_ws/demon/datasets/scenes11_test.h5')
...
if True:
    ...
    for fileIdx in range(len(inputSUN3D_trainFilePaths)):
        ...
        for h5key in data.keys():
            # if h5key.split('-')[0] == 'mit_w85k1.whole_apartment':
            if h5key.split('-')[0][:-3] == '2000':
                # image_name = ('{0}~{1}').format(h5key.split('.')[0], h5key.split('.')[1])
                image_name = h5key.split('.')[0]
