...
outfile = "/media/kevin/SamsungT5_F/ThesisDATA/SUN3D/mit_32_123~classroom_32123_nov_2_2012_scan1_erika/demon_prediction/demon_mit_32_123~classroom_32123_nov_2_2012_scan1_erika.h5"
...
inputSUN3D_trainFilePaths.append('/media/kevin/SamsungT5_F/ThesisDATA/SUN3D/mit_32_123~classroom_32123_nov_2_2012_scan1_erika/GT_mit_32_123~classroom_32123_nov_2_2012_scan1_erika.h5')
...
if True:
    ...
    for fileIdx in range(len(inputSUN3D_trainFilePaths)):
        ...
        for h5key in data.keys():
            if h5key.split('-')[0] == 'mit_32_123~classroom_32123_nov_2_2012_scan1_erika':
                image_name = h5key
