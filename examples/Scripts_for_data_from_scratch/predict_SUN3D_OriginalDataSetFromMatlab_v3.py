...
outdir = "/media/kevin/SamsungT5_F/ThesisDATA/SUN3D/mit_46_ted_lab1~ted_lab_2/demon_prediction"
outfile = "/media/kevin/SamsungT5_F/ThesisDATA/SUN3D/mit_46_ted_lab1~ted_lab_2/demon_prediction/demon_mit_46_ted_lab1~ted_lab_2.h5"
...
inputSUN3D_trainFilePaths.append('/media/kevin/SamsungT5_F/ThesisDATA/SUN3D/mit_46_ted_lab1~ted_lab_2/mit_46_ted_lab1~ted_lab_2.h5')
...
if True:
    ...
    for fileIdx in range(len(inputSUN3D_trainFilePaths)):
        ...
        for h5key in data.keys():
            if h5key.split('-')[0] == 'mit_46_ted_lab1~ted_lab_2':
                image_name = h5key
