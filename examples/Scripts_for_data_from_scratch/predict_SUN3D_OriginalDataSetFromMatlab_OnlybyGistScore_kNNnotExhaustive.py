...
outdir = "/media/kevin/SamsungT5_F/ThesisDATA/SUN3D/home_ts~apartment_ts_oct_31_2012_scan1_erika/demon_prediction_Gist066_kNNOneThird"
outfile = "/media/kevin/SamsungT5_F/ThesisDATA/SUN3D/home_ts~apartment_ts_oct_31_2012_scan1_erika/demon_prediction_Gist066_kNNOneThird/demon_Gist066_home_ts~apartment_ts_oct_31_2012_scan1_erika.h5"
...
inputSUN3D_trainFilePaths.append('/media/kevin/SamsungT5_F/ThesisDATA/SUN3D/home_ts~apartment_ts_oct_31_2012_scan1_erika/GT_home_ts~apartment_ts_oct_31_2012_scan1_erika.h5')
...
if True:
    ...
    for fileIdx in range(len(inputSUN3D_trainFilePaths)):
        ...
        for h5key in data.keys():
            if h5key.split('-')[0] == 'home_ts~apartment_ts_oct_31_2012_scan1_erika':
                image_name = h5key
