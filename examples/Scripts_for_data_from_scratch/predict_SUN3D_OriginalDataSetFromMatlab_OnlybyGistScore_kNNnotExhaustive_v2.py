...
outdir = "/media/kevin/SamsungT5_F/ThesisDATA/SUN3D/hotel_graz~scan1_2012_aug_29/demon_prediction_Gist066_kNNOneThird"
outfile = "/media/kevin/SamsungT5_F/ThesisDATA/SUN3D/hotel_graz~scan1_2012_aug_29/demon_prediction_Gist066_kNNOneThird/demon_Gist066_hotel_graz~scan1_2012_aug_29.h5"
...
inputSUN3D_trainFilePaths.append('/media/kevin/SamsungT5_F/ThesisDATA/SUN3D/hotel_graz~scan1_2012_aug_29/GT_hotel_graz~scan1_2012_aug_29.h5')
...
if True:
    ...
    for fileIdx in range(len(inputSUN3D_trainFilePaths)):
        ...
        for h5key in data.keys():
            if h5key.split('-')[0] == 'hotel_graz~scan1_2012_aug_29':
                image_name = h5key
