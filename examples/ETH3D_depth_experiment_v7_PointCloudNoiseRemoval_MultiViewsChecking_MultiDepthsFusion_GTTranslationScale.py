...
image_dir_path = '/home/kevin/ThesisDATA/ETH3D/multi_view_training_dslr_undistorted/facade/DenseSIFT/resized_images_4032_5376'
...
for file in os.listdir(image_dir_path):
    if file.endswith(".JPG"):
        cntTmp += 1
        print(os.path.join(image_dir_path, file))
        image1_filename_set.add(file)
        if cntTmp>=max_num_ref_img:
            break
# image1_filename_set.add('DSC_0324.JPG')
# image1_filename_set.add('DSC_0326.JPG')
# image1_filename_set.add('DSC_0327.JPG')
# image1_filename_set.add('DSC_0328.JPG')
# image1_filename_set.add('DSC_0331.JPG')
# image1_filename_set.add('DSC_0332.JPG')
# image1_filename_set.add('DSC_0335.JPG')
# image1_filename_set.add('DSC_0336.JPG')
# image1_filename_set.add('DSC_0338.JPG')
# image1_filename_set.add('DSC_0341.JPG')
# image1_filename_set.add('DSC_0344.JPG')
# image1_filename_set.add('DSC_0346.JPG')
# image1_filename_set.add('DSC_0349.JPG')
# image1_filename_set.add('DSC_0364.JPG')
# image1_filename_set.add('DSC_0369.JPG')
# image1_filename_set.add('DSC_0371.JPG')
# image1_filename_set.add('DSC_0373.JPG')
# image1_filename_set.add('DSC_0378.JPG')
# image1_filename_set.add('DSC_0382.JPG')
# image1_filename_set.add('DSC_0386.JPG')
# image1_filename_set.add('DSC_0394.JPG')
# image1_filename_set.add('DSC_0396.JPG')
# image1_filename_set.add('DSC_0404.JPG')
# image1_filename_set.add('DSC_0406.JPG')
# image1_filename_set.add('DSC_0411.JPG')
# image1_filename_set.add('DSC_0414.JPG')
# image1_filename_set.add('DSC_0420.JPG')
# image1_filename_set.add('DSC_0422.JPG')
...
def findMultiPairs(infile, ExhaustivePairInfile, data_format, target_K, w, h, cameras, images, TheiaGlobalPosesGT, TheiaRelativePosesGT, image1_filename_set):
    ...
    for image_pair12 in (data.keys()):
        ...
        tmpGTDepth2[np.isinf(tmpGTDepth2)]=0.0
        ...
        ##### compute scales
        correctionScaleGT12 = computeCorrectionScale(data[image_pair12]['depth_upsampled'].value, GT_depth_1, 60)
        correctionScaleColmap12 = computeCorrectionScale(data[image_pair12]['depth_upsampled'].value, view1.depth, 60)
        correctionScaleGT21 = computeCorrectionScale(data[image_pair21]['depth_upsampled'].value, GT_depth_2, 60)
        ...
        One2MultiImagePairs_GT[image_pair12] = One2MultiImagePair(name1=image_name1, name2=image_name2, image1=view1GT.image, image2=view2GT.image, depth1=GT_depth_1, depth2=GT_depth_2, Extrinsic1_4by4=GTExtrinsics1_4by4, Extrinsic2_4by4=GTExtrinsics2_4by4, Relative12_4by4=np.dot(GTExtrinsics2_4by4, np.linalg.inv(GTExtrinsics1_4by4)), Relative21_4by4=np.dot(GTExtrinsics1_4by4, np.linalg.inv(GTExtrinsics2_4by4)), scale12=transScaleGT, scale21=transScaleGT)
        One2MultiImagePairs_correctionGT[image_pair12] = One2MultiImagePair(name1=image_name1, name2=image_name2, image1=view1GT.image, image2=view2GT.image, depth1=GT_depth_1, depth2=GT_depth_2, Extrinsic1_4by4=GTExtrinsics1_4by4, Extrinsic2_4by4=GTExtrinsics2_4by4, Relative12_4by4=np.dot(GTExtrinsics2_4by4, np.linalg.inv(GTExtrinsics1_4by4)), Relative21_4by4=np.dot(GTExtrinsics1_4by4, np.linalg.inv(GTExtrinsics2_4by4)), scale12=correctionScaleGT12, scale21=correctionScaleGT21)
        ...
        One2MultiImagePairs_GT[image_pair21] = One2MultiImagePair(name1=image_name2, name2=image_name1, image1=view2GT.image, image2=view1GT.image, depth1=GT_depth_2, depth2=GT_depth_1, Extrinsic1_4by4=GTExtrinsics2_4by4, Extrinsic2_4by4=GTExtrinsics1_4by4, Relative12_4by4=np.dot(GTExtrinsics1_4by4, np.linalg.inv(GTExtrinsics2_4by4)), Relative21_4by4=np.dot(GTExtrinsics2_4by4, np.linalg.inv(GTExtrinsics1_4by4)), scale12=transScaleGT, scale21=transScaleGT)
        One2MultiImagePairs_correctionGT[image_pair21] = One2MultiImagePair(name1=image_name2, name2=image_name1, image1=view2GT.image, image2=view1GT.image, depth1=GT_depth_2, depth2=GT_depth_1, Extrinsic1_4by4=GTExtrinsics2_4by4, Extrinsic2_4by4=GTExtrinsics1_4by4, Relative12_4by4=np.dot(GTExtrinsics1_4by4, np.linalg.inv(GTExtrinsics2_4by4)), Relative21_4by4=np.dot(GTExtrinsics2_4by4, np.linalg.inv(GTExtrinsics1_4by4)), scale12=correctionScaleGT21, scale21=correctionScaleGT12)
        DeMoNRelative12_4by4 = np.eye(4)
        DeMoNRelative12_4by4[0:3,0:3] = data[image_pair12]['rotation'].value
        DeMoNRelative12_4by4[0:3,3] = data[image_pair12]['translation'].value
...
def main():
    ...
    plywriter = vtk.vtkPLYWriter()
    plywriter.SetFileName(('facade_GTTranslationScale_multiviewchecking_multidepthfusion_filtered_pointcloud.ply'))
