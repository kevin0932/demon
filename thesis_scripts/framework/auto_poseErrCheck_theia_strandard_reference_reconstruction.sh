...
#  colmap_export_path=$dataset_dir/DenseSIFT/$matched_database_suffix$tmpChar$image_pair_retrieval_params$tmpChar$opt_image_scale_factor$tmpChar$opt_OF_scale_factor$tmpChar$opt_uncertainty_radius
  ...
  /home/kevin/devel_lib/SfM/TheiaSfM/theia-release/bin/read_colmap_relativeRt_to_theia_output_matchfile --matchfile=$tmp_cereal_file --colmap_global_poses_images_textfile=$dataset_dir/DenseSIFT/sparse/0/images.txt
