...
do
  ...
  /home/kevin/devel_lib/SfM/TheiaSfM/theia-release/bin/read_colmap_relativeRt_to_theia_output_matchfile --matchfile=$theia_match_file --colmap_global_poses_images_textfile=$dataset_dir/DenseSIFT/sparse/0/images.txt
