...
#### ETH3D Train other datasets
outdir = "/home/kevin/ThesisDATA/ETH3D/multi_view_training_dslr_undistorted/relief/demon_prediction_exhaustive_pairs"
recondir = '/home/kevin/ThesisDATA/ETH3D/multi_view_training_dslr_undistorted/relief/DenseSIFT/dense_192_256'
cameras = colmap.read_cameras_txt(os.path.join(recondir,'sparse','cameras.txt'))
images = colmap.read_images_txt(os.path.join(recondir,'sparse','images.txt'))

ExhaustivePairInfile = "/home/kevin/ThesisDATA/ETH3D/multi_view_training_dslr_undistorted/terrains/demon_prediction_exhaustive_pairs/kevin_southbuilding_demon.h5"
infile = '/home/kevin/ThesisDATA/ETH3D/multi_view_training_dslr_undistorted/terrains/demon_prediction_exhaustive_pairs/BothSideSurvivor_OrderEnforced_OpticalFlow_360_360_full_quantization_map_OFscale_1_err_16000_survivorRatio_400_validPairNum_114.txt'
depth_dir_path = '/home/kevin/ThesisDATA/ETH3D/multi_view_training_depth/terrains/ground_truth_depth/dslr_images'
ground_truth_dir_path = '/home/kevin/ThesisDATA/ETH3D/multi_view_training_dslr_undistorted/terrains/dslr_calibration_undistorted'
imagesGT = read_images_txt_and_return_dict_index_by_name(os.path.join(ground_truth_dir_path,'images_onlyImageNames.txt'))
...
def visPointCloudInGlobalFrame(renderer, alpha, infile, ExhaustivePairInfile, data_format, target_K, w, h, cameras, images, TheiaGlobalPosesGT, TheiaRelativePosesGT, PoseSource='Theia', DepthSource='DeMoN', initBool=False):
    ...
    for pair_idx in range(len(image_pair_list)):
        ...
        transScaleTheia = transScaleGT
        transScaleColmap = transScaleGT
