...
def main():
    ...
    # theia_relativeposes_from_globalposes_GTfilepath = '/media/kevin/SamsungT5_F/ThesisDATA/southbuilding/DBs/intermediate_results/RelativePoses_after_step7_global_position_estimation.txt'
    # theia_id_name_filepath = '/media/kevin/SamsungT5_F/ThesisDATA/southbuilding/DBs/intermediate_results/viewid_imagename_pairs_file.txt'
    theia_relativeposes_from_globalposes_GTfilepath = '/media/kevin/SamsungT5_F/ThesisDATA/southbuilding/DBs/intermediate_results/RelativePoses_after_step7_global_position_estimation.txt'
    theia_id_name_filepath = '/media/kevin/SamsungT5_F/ThesisDATA/southbuilding/DBs/intermediate_results/viewid_imagename_pairs_file.txt'
    ...
    for image_pair12 in data.keys():
        ...
        image_pair21_transVec = t21_from_theia_motion_averaging
