...
#     #plt.show()
    ...
    plt.xlabel("pairwise rotation consistency error in radians", fontsize=14)
    plt.savefig(os.path.join(args.output_path,"thesis_rotation_pose_consistency_list_histogram.png"))
    #plt.show()
    plt.figure()
    plt.hist(np.array(rotation_pose_consistency_list) * 180.0 / math.pi, normed=False, bins=int(total_pair_num/20))
    plt.ylabel('Counts', fontsize=14);
    plt.xlabel("pairwise rotation consistency error in degrees", fontsize=14)
    plt.savefig(os.path.join(args.output_path,"thesis_rotation_pose_consistency_list_histogram_inDegrees.png"))
    #plt.show()
    ...
    plt.ylabel('Counts', fontsize=14);
    plt.xlabel("pairwise translation consistency error in radians", fontsize=14)
    plt.savefig(os.path.join(args.output_path,"thesis_translation_pose_camvec_consistency_list_histogram_inRadians.png"))
    #plt.show()
    plt.figure()
    plt.hist(np.array(translation_pose_camvec_consistency_list) * 180.0 / math.pi, normed=False, bins=int(total_pair_num/20))
    plt.ylabel('Counts', fontsize=14);
    plt.xlabel("pairwise translation consistency error in degrees", fontsize=14)
    plt.savefig(os.path.join(args.output_path,"thesis_translation_pose_camvec_consistency_list_histogram_inDegrees.png"))
    #plt.show()
    ...
    plt.ylabel('Counts', fontsize=14);
    plt.xlabel("rotation error in degrees", fontsize=14)
    plt.savefig(os.path.join(args.output_path,"thesis_rotation_pose_accuracy_list_histogram_inDegrees.png"))
    #plt.show()
    plt.figure()
    plt.hist(translation_pose_camvec_accuracy_list, normed=False, bins=int(total_pair_num/20))
    plt.ylabel('Counts', fontsize=14);
    plt.xlabel("translation error in degrees", fontsize=14)
    plt.savefig(os.path.join(args.output_path,"thesis_translation_pose_camvec_accuracy_list_histogram_inDegrees.png"))
    #plt.show()
